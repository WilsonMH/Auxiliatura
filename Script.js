...
function triangulo() {
	...
	if (7 < lim){
		...
		var g0 = (f + f0);
		var g1 = (f0 + f1);
		document.getElementById("fila7").innerHTML = "1"+"---"+(g)+"--"+(g0)+"--"+(g1)+"--"(g1)+"--"+(g0)+"--"+(g)+"---"+"1";
	}
	...
	if (8 < lim){
		...
		var h1 = (g0 + g1);
		var h2 = (g1 + g1);
		document.getElementById("fila8").innerHTML = "1"+"---"+(h)+"--"+(h0)+"--"+(h1)+"--"+(h2)+"--"+(h1)+"--"+(h0)+"--"+(h)+"---"+"1";
	}
	...
	if (9 < lim){
		...
		var i1 = (h0 + h1);
		var i2 = (h1 + h2);
		document.getElementById("fila9").innerHTML = "1"+"---"+(i)+"--"+(i0)+"--"+(i1)+"--"+(i2)+"--"+(i2)+"--"+(i1)+"--"+(i0)+"--"+(i)+"---"+"1";
	}
}
